...
export default function AddNewCard({ onClick }) {
  return (
    <button onClick={onClick} className="group w-full min-h-[180px] rounded-2xl border-2 border-dashed border-outline-variant/50 flex flex-col items-center justify-center gap-3 hover:border-primary/50 hover:bg-primary/5 transition-all duration-200 cursor-pointer bg-transparent p-6">
      {/* Circular icon */}
