    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div className="space-y-1">
        ...
        <div className="relative">
          <input id="s-pw" type={showPw ? "text" : "password"} placeholder="••••••••" required
            ...
            className="w-full px-3 py-2.5 pr-10 bg-surface-container-low border border-outline-variant/60 rounded-xl focus:border-primary focus:shadow-[0_0_0_3px_rgba(99,14,212,0.10)] outline-none text-xs text-on-surface placeholder:text-on-surface-variant/50 transition-all duration-150"
          />
      ...
      <div className="space-y-1">
        ...
        <input id="s-confirm" type="password" placeholder="••••••••" required
          ...
          className={cn(
            "w-full px-3 py-2.5 bg-surface-container-low border rounded-xl focus:shadow-[0_0_0_3px_rgba(99,14,212,0.10)] outline-none text-xs text-on-surface placeholder:text-on-surface-variant/50 transition-all duration-150",
            confirmErr ? "border-error focus:border-error" : "border-outline-variant focus:border-primary"
          )}
        />
        {confirmErr && <p className="text-xs ml-0.5 text-error">{confirmErr}</p>}
      </div>
